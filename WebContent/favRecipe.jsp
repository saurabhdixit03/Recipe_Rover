...
<body>
	...
	<jsp:include page="/showFavRecipeServlet" />
				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__option">
							<a href="./index.jsp">Home</a> <span>My Favorite</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							<li><a href="ReportSearchByName.jsp">Search Recipe By name</a></li>
							<li><a href="ReportSearchByDate.jsp">Search By Date</a></li>
						</ul>
					</nav>
				</div>
			</div>
