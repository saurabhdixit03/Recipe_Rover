		...
		<div class="row">
			<div class="col-lg-3">
				<div class="header__logo">
					<a href="./index.html"><img src="images/logo1.PNG" alt=""></a><a class="nav-link py-3 px-0 px-lg-3 rounded">Welcome <%=uname%>!
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="product__details__text">
						...
						<%
						// Split the recipe details into different sections based on "Ingredients" and "Instructions"
						String[] recipeParts = recipeDetails.split("Ingredients:|Instructions:");

						// Ensure the recipe has at least three parts: name, ingredients, and instructions
						if (recipeParts.length >= 3) {
							String recipeName = recipeParts[0].trim(); // Extract the recipe name
							String ingredients = recipeParts[1].trim(); // Extract the ingredients
							String instructions = recipeParts[2].trim(); // Extract the instructions

							// Output the trimmed recipe details
						%>

						<strong>Recipe Name:</strong>
						<%=recipeName%><br> <strong>Ingredients:</strong>
						<%=ingredients%><br> <strong>Instructions:</strong>
						<%=instructions%>
						<form id="addToFav" action="AddToFavServlet" method="post">
							<!-- Hidden fields for storing recipe details -->
							<input type="hidden" name="recipeName" value="<%=recipeName%>">
							<input type="hidden" name="ingredients" value="<%=ingredients%>">
							<input type="hidden" name="instructions" value="<%=instructions%>">

							<button type="submit" class="primary-btn">ADD TO FAVORITE</button>
						</form>
						<%
						} else {
						out.println("No Recipe found for given ingrediants");
						}
						%>
