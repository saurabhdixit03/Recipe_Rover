				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__option">
							<a href="./index.jsp">Home</a><a href="./favRecipe.jsp">My Favorite</a> <span>Search By Name</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3">
					<nav class="header__menu">
						<ul>
							<li><a href="#">Search Recipe By name</a></li>
							 
						</ul>
					</nav>
				</div>
				<div class="col-lg-3">
				<form action="reportsearchbynameservlet" method="post">
