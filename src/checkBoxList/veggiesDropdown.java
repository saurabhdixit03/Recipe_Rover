...
public class veggiesDropdown {
    ...
    public static JSONArray getChoicesFromAPI() {
        ...
        try {
            ...
            String data = "{\"prompt\": \" give me list of 30 commonly used vegetables and write indian names of Vegetables into bracket:\", \"max_tokens\": 500}";
